...
pub const HEADER: &str = "address,packets,best_rssi_dbm,last_seen_s";
...
mod tests {
    ...
    fn an_empty_census_exports_a_header_and_no_rows() {
        ...
        // The header still names four columns: the shape of the answer is
    ...
    fn the_rows_come_out_in_the_order_the_panel_is_showing() {
        ...
        assert!(
            by_packets[0].starts_with("a4:83:e7:1c:09:be,1204,-41.2,"),
            "{}",
            by_packets[0]
        );
        assert!(
